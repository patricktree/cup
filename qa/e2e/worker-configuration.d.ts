/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 401b6cb243dc1bd9047a065a4c5134d3)
// Runtime types generated with workerd@1.20260921.1 2026-08-18 
interface __BaseEnv_Env {
	AUDIO_BUCKET: R2Bucket;
	ASSETS: Fetcher;
	QA_SCENARIO: "success";
	CONVERSION_GRANTS: DurableObjectNamespace<import("./src/worker").ConversionGrantDurableObject>;
	CONVERSION_GRANT_REGISTRY: DurableObjectNamespace<import("./src/worker").ConversionGrantRegistryDurableObject>;
	CREATE_AUDIOBOOK_FROM_URL_WORKFLOW: Workflow<Parameters<import("./src/worker").CreateAudiobookFromUrlQaWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "ConversionGrantDurableObject" | "ConversionGrantRegistryDurableObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "QA_SCENARIO">> {}
}
declare module "*.html" {
	const value: string;
